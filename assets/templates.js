...
(function (SIK) {
  ...
  var DOCS = [
    { id: 'plan', kind: 'sheet', order: 1, file: 'project-plan',
      ...
      helps: "Turns the whole thing into dated tasks with a name against each one, so nothing sits waiting on someone who does not know it is theirs.",
    ...
    { id: 'gantt', kind: 'sheet', order: 2, file: 'gantt-chart',
      ...
      helps: "Puts the shape of the work on one screen, so you can show it in a meeting instead of explaining it.",
    ...
    { id: 'raci', kind: 'sheet', order: 3, file: 'raci-matrix',
      ...
      helps: "Forces exactly one accountable name per workstream, and tells you which rows still do not have one.",
    ...
    { id: 'charter', kind: 'doc', order: 4, file: 'project-charter',
      ...
      helps: "Gets the objective, the scope, and what is deliberately out of scope written down once, so you stop relitigating it.",
    ...
    { id: 'risks', kind: 'sheet', order: 5, file: 'risk-register',
      uses: ['team', 'template'],
      helps: "Makes you rate what could go wrong while you can still act on it, and gives anything serious a named owner and a date.",
    ...
    { id: 'stakeholders', kind: 'sheet', order: 6, file: 'stakeholder-map',
      uses: ['team', 'sponsor'],
      helps: "Sorts people by influence and interest, so you brief the right ones before decisions rather than after.",
    ...
    { id: 'decisions', kind: 'sheet', order: 7, file: 'decision-log',
      uses: ['team'],
      helps: "Records what was decided and what was rejected, so the same argument does not come back in six weeks.",
    ...
    { id: 'status', kind: 'doc', order: 8, file: 'status-report-template',
      ...
      helps: "A repeatable update where every blocker carries a named ask, so your reports are not a list of complaints.",
    ...
    { id: 'kickoff', kind: 'doc', order: 9, file: 'kickoff-agenda',
      uses: ['team'],
      helps: "Turns the first meeting into decisions instead of a briefing, with the pre-reads doing the information work.",
    ...
    { id: 'onepager', kind: 'doc', order: 10, file: 'update-onepager',
      ...
      helps: "One page you can send a sponsor or funder without rewriting it each time.",
